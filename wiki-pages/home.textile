...
| "@vim-official@":http://github.com/gpwen/vim-installer-mui2/tree/vim-official | NSIS scripts from the "official mercurial repository of Vim":http://www.vim.org/mercurial.php.  It's used to track the official code base (manually). |
