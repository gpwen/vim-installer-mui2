...
LangString str_group_old_ver        ${LANG_FRENCH} \
...
LangString str_group_edit_with      ${LANG_FRENCH} \
...
LangString str_section_vis_vim      ${LANG_FRENCH} \
    "VisVim Extension"
LangString str_desc_vis_vim         ${LANG_FRENCH} \
    "VisVim Extension for Microsoft Visual Studio integration."

LangString str_section_xpm          ${LANG_FRENCH} \
    "XPM Library"
LangString str_desc_xpm             ${LANG_FRENCH} \
...
LangString str_unsection_rc         ${LANG_FRENCH} \
    "Remove Vim Config File"
LangString str_desc_rm_rc           ${LANG_FRENCH} \
