...
LangString str_group_old_ver        ${LANG_SWEDISH} \
...
LangString str_group_edit_with      ${LANG_SWEDISH} \
...
LangString str_section_vis_vim      ${LANG_SWEDISH} \
    "VisVim Extension"
LangString str_desc_vis_vim         ${LANG_SWEDISH} \
    "VisVim Extension for Microsoft Visual Studio integration."

LangString str_section_xpm          ${LANG_SWEDISH} \
    "XPM Library"
LangString str_desc_xpm             ${LANG_SWEDISH} \
...
LangString str_unsection_rc         ${LANG_SWEDISH} \
    "Remove Vim Config File"
LangString str_desc_rm_rc           ${LANG_SWEDISH} \
