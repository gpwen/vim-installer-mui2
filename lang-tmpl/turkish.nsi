...
LangString str_dest_folder          ${LANG_TURKISH} \
...
LangString str_group_old_ver        ${LANG_TURKISH} \
...
LangString str_section_quick_launch ${LANG_TURKISH} \
    "In the Quick Launch Bar"
LangString str_desc_quick_launch    ${LANG_TURKISH} \
    "Add Vim shortcut in the quick launch bar."

LangString str_group_edit_with      ${LANG_TURKISH} \
    "Add Vim Context Menu"
LangString str_desc_edit_with       ${LANG_TURKISH} \
    "Add Vim to the $\"Open With...$\" context menu list."

LangString str_section_edit_with32  ${LANG_TURKISH} \
    "32-bit Version"
LangString str_desc_edit_with32     ${LANG_TURKISH} \
    "Add Vim to the $\"Open With...$\" context menu list \
     for 32-bit applications."

LangString str_section_edit_with64  ${LANG_TURKISH} \
    "64-bit Version"
LangString str_desc_edit_with64     ${LANG_TURKISH} \
    "Add Vim to the $\"Open With...$\" context menu list \
...
LangString str_section_xpm          ${LANG_TURKISH} \
    "XPM Library"
LangString str_desc_xpm             ${LANG_TURKISH} \
...
LangString str_unsection_rc         ${LANG_TURKISH} \
    "Remove Vim Config File"
LangString str_desc_rm_rc           ${LANG_TURKISH} \
...
LangString str_msg_too_many_ver  ${LANG_TURKISH} \
    "Found $vim_old_ver_count Vim versions on your system.$\r$\n\
     This installer can only handle ${VIM_MAX_OLD_VER} versions \
     at most.$\r$\n\
     Please remove some versions and start again."

LangString str_msg_invalid_root  ${LANG_TURKISH} \
    "Invalid install path: $vim_install_root!$\r$\n\
     It should end with $\"vim$\"."

LangString str_msg_bin_mismatch  ${LANG_TURKISH} \
    "Binary path mismatch!$\r$\n$\r$\n\
     Expect the binary path to be $\"$vim_bin_path$\",$\r$\n\
     but system indicates the binary path is $\"$INSTDIR$\"."

LangString str_msg_vim_running   ${LANG_TURKISH} \
    "Vim is still running on your system.$\r$\n\
     Please close all instances of Vim before you continue."

LangString str_msg_register_ole  ${LANG_TURKISH} \
    "Attempting to register Vim with OLE. \
     There is no message indicates whether this works or not."

LangString str_msg_unreg_ole     ${LANG_TURKISH} \
    "Attempting to unregister Vim with OLE. \
     There is no message indicates whether this works or not."

LangString str_msg_rm_start      ${LANG_TURKISH} \
    "Uninstalling the following version:"

LangString str_msg_rm_fail       ${LANG_TURKISH} \
    "Fail to uninstall the following version:"

LangString str_msg_no_rm_key     ${LANG_TURKISH} \
    "Cannot find uninstaller registry key."

LangString str_msg_no_rm_reg     ${LANG_TURKISH} \
    "Cannot find uninstaller from registry."

LangString str_msg_no_rm_exe     ${LANG_TURKISH} \
    "Cannot access uninstaller."

LangString str_msg_rm_copy_fail  ${LANG_TURKISH} \
    "Fail to copy uninstaller to temporary directory."

LangString str_msg_rm_run_fail   ${LANG_TURKISH} \
    "Fail to run uninstaller."

LangString str_msg_abort_install ${LANG_TURKISH} \
...
LangString str_msg_rm_root_fail  ${LANG_TURKISH} \
